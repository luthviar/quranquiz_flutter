...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    FirebaseAdMob.instance.initialize(appId: "ca-app-pub-5518200916880952~9634498708").then((response) {
      myBanner..load()..show(
            ...
            slivers: <Widget>[
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Text("Select a surah to start the quiz", style: TextStyle(
                    color: Colors.white,
